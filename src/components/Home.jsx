...
<div className="w-full flex justify-center fixed top-6 z-50">
  ...
  <div className="absolute -inset-10 opacity-20">
    {/* Blue Circle - Slower pulse with easing */}
    <div 
    ...
    {/* Indigo Circle - Different timing */}
    <div 
    ...
    {/* Cyan Circle - Slowest with offset */}
    <div 
...
`}</style>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between w-9/12 mx-auto py-20 gap-16 z-10">
        ...
        <div className="md:w-1/2 space-y-6 text-center md:text-left">
          ...
          <div className="flex gap-4 justify-center md:justify-start pt-4">
            <a href="/projects">
              <button className="px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-md text-white font-medium hover:shadow-lg hover:shadow-cyan-500/30 transition duration-300">
                View Projects
              </button>
            </a>
            <a href="/contact">
              <button className="px-6 py-3 border border-cyan-400 rounded-md text-cyan-400 font-medium hover:bg-cyan-400/10 transition-all duration-300">
                Contact Me
              </button>
            </a>
          </div>
        ...
        <div className="relative w-[400px] h-[400px]">
         {/* Outer Circle Background with Arrows */}
      <div className="absolute inset-0 flex items-center justify-center opacity-20">
        ...
        >
          ...
          {/* Arrow paths (curved lines with arrowheads) */}
          <path 
            d="M300,20 A280,280 0 0,1 520,300" 
            stroke="gray" 
            strokeOpacity="0.3" 
            fill="none"
          ...
          />
          <path 
            d="M460,140 A200,200 0 0,1 460,460" 
            stroke="gray" 
            strokeOpacity="0.3" 
            fill="none"
            markerEnd="url(#arrowhead)"
          />
          <path 
            d="M300,180 A120,120 0 0,1 420,300" 
            stroke="gray" 
            strokeOpacity="0.3" 
            fill="none"
            markerEnd="url(#arrowhead)"
  ...
  <button
    ...
    className="p-2 rounded-full bg-gray-800/80 border border-gray-700 hover:border-cyan-400 group transition-all duration-300"
